$(document).ready(function(){
    ...
    */
    ...
    // Show scroll button iff user cannot see post header    
    function toggleScrollTopBtn() {
        var distFromTop = $(document).scrollTop();
        var header_h = $('.post-header').outerHeight();

        if(distFromTop > header_h) {
            // scrollTopBtn.show();
    ...
    // Add scroll listener
    $(document).scroll(toggleScrollTopBtn);
    // Run scroll toggle (needed when user starts in middle of page after refresh)
    toggleScrollTopBtn();
